...
{
	DrawSpriteNonChroma(x, y, srcRect, GetRect(), s);
}
...
{
	DrawSprite(x, y, srcRect, GetRect(), s, chroma);
}
...
{
	DrawSpriteSubstitute(x, y, substitute, srcRect, GetRect(), s, chroma);
}
