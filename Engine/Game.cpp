...
void Game::UpdateModel()
{
	...
	else
	{
		...
		while (!wnd.mouse.IsEmpty())
		{
			...
			switch (s)
			{
			case SelectionMenu::Size::Small: // Non-freeplay score: 1450
				CreateGrid(2, 2);
				onTitleScreen = false;
				break;
			case SelectionMenu::Size::Medium: // Non-freeplay score: 1950
				CreateGrid(3, 3);
				onTitleScreen = false;
				break;
			case SelectionMenu::Size::Large: // Non-freeplay score: 2650
				CreateGrid(4, 4);
				onTitleScreen = false;
				break;
			}
